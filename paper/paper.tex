...
%%Research highlights
\begin{highlights}
\item This paper presents a technique for estimating the parameters of the nested multinomial logit choice model in a dynamic computational setting. 
